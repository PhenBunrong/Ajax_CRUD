                                    ...
                                    @foreach ($student as $row)
                                        <tr id="sid{{$row->id}}">
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:void(0)" onclick="deleteStudent({{$row->id}})" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
      ...
      $("#studentForm").submit(function(e){
          ...
          $.ajax({
              ...
              success: function (res) {
                if(res){
                    $("#studentTable tbody").prepend('<tr><td>'+res.firstname+'</td><td>'+res.lastname+'</td><td>'+res.email+'</td><td>'+res.phone+'</td><td><a href="javascript:void(0)" onclick="editStudent('+res.id+')" class="btn btn-info">Edit</a> <a href="javascript:void(0)" onclick="deleteStudent('+res.id+')" class="btn btn-danger">Delete</a></td></tr>');
                    $("#studentForm")[0].reset();
